      ...
      <div className={styles.formularioDiv}>
        <div className={styles.formulario}>
          ...
          <div className={styles.divForm}>
            <p>Nome no Cartão</p>
            <input type="text" id="valor" placeholder="John Dell" required="required" name="valor" value={valor2} onChange={handleChange2}  className={styles.entrada}/>
           </div>

           <div className={styles.divForm}>
            <p>Numero do Cartão</p>
            <input type="number" id="numeroid" placeholder="1234 4567 8912 3456"  maxLength="1" required="required" name="numero" value={valor} onChange={handleChange} className={styles.entrada2} />
           </div>
           ...
           <div className={styles.dataPlusCvc}>
            <div className={styles.divForm}>
             <p>Validade (MM / AA)</p>
              <div className={styles.divForm2}>
                <input type="number" id="dataid" placeholder="MM" required="required" name="data" value={valor3} onChange={handleChange3} className={styles.entrada3}/>
                <input type="number" id="datatwoid" placeholder="AA" required="required" name="dataTwo" value={valor4} onChange={handleChange4} className={styles.entrada4}/>
              </div>
            </div>
            ...
            <div className={styles.divForm}>
              ...
              <input type="number" id="segurancaid" placeholder="123" required="required" name="seguranca" value={valor5} onChange={handleChange5} className={styles.entrada5} />
            </div>
           </div>
           <button className={styles.botao} onClick={handleButtonClick}>Confirmar</button>
